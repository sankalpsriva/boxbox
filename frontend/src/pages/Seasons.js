...
function Seasons() {
  ...
  const seasons = [
    {year: 2025, status: 'current', description: 'Current Season'},
    { year: 2024, status: 'completed', description: 'Legendary Season'},
    { year: 2023, status: 'completed', description: 'Championship Season' },
    { year: 2022, status: 'completed', description: 'Max Verstappen Champion' },
    { year: 2021, status: 'completed', description: 'Historic Battle' },
    { year: 2020, status: 'completed', description: 'COVID-19 Season' },
    { year: 2019, status: 'completed', description: 'Mercedes Dominance' },
    { year: 2018, status: 'completed', description: 'Hamilton vs Vettel' },
    { year: 2017, status: 'completed', description: 'Close Championship' },
    { year: 2016, status: 'completed', description: 'Rosberg Champion' },
    { year: 2015, status: 'completed', description: 'Hamilton Dominant' },
  ];
