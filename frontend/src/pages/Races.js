      ...
      <section className="text-center mb-12">
        <div className="max-w-4xl mx-auto">
          <h1 className="text-5xl font-bold text-white mb-6">
            F1 <span className="text-red-500">Races</span>
          </h1>
          <p className="text-xl text-gray-300 mb-8 leading-relaxed">
            Browse all Formula 1 races, rate your favorites, and discover the most 
            thrilling moments in motorsport history. Every overtake, every battle, 
            every championship-deciding moment.
          </p>
          <div className="bg-gray-900 rounded-xl p-8 border border-gray-700">
            <h2 className="text-2xl font-bold text-white mb-4">Coming Soon</h2>
            <p className="text-gray-400">
              Complete race database and rating system will be available here soon!
            </p>
          </div>
        </div>
      </section>
